...
js = js.replace(
  ...
  'd.jsx("button",{type:"button",className:"gw-btn gw-btn-ghost gw-title-quick",onClick:()=>C("/deploy"),children:"Quick Deploy"}),d.jsx("button",{type:"button",className:"gw-btn gw-btn-ghost gw-title-secondary",onClick:()=>C("/mp"),children:"Multiplayer"})',
);
js = js.replace(
  'onClick:()=>C("/play"),children:"Quick Battle"',
  'onClick:()=>C("/deploy"),children:"Quick Deploy"',
);

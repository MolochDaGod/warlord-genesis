...
// ΓöÇΓöÇ Scene ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
for (const [key, label, min, max] of SCALE_META) {
  ...
  wrap.innerHTML = `<div class="row"><span>${label}</span><span class="v" id="v-${key}">${prefs.scales[key].toFixed(2)}├ù</span></div>`;
  ...
  input.addEventListener("input", () => {
    ...
    document.getElementById(`v-${key}`).textContent = `${prefs.scales[key].toFixed(2)}├ù`;
    rebuildMap();
  });
